...
class StatsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create stat" do
    assert_difference("Stat.count") do
      post stats_url, params: { stat: { athlete_id: @stat.athlete_id, concept_id: @stat.concept_id, game_id: @stat.game_id, value: @stat.value } }
    end
  ...
  test "should update stat" do
    patch stat_url(@stat), params: { stat: { athlete_id: @stat.athlete_id, concept_id: @stat.concept_id, game_id: @stat.game_id, value: @stat.value } }
